...
public class ErrorMessage {
    ...
    public final static String MESSAGE_ERROR_ELEMENT_JSON_RECLAMATIONS_MISSING = "L'ELEMENT RECLAMATIONS DU FICHIER XML D'ENTRE EST MANQUANT";
    public final static String MESSAGE_ERROR_ELEMENT_JSON_FOLDER_MISSING = "L'ELEMENT DOSSIER DU FICHIER XML D'ENTRE EST MANQUANT";
    public final static String MESSAGE_ERROR_ELEMENT_JSON_MONTH_MISSING = "L'ELEMENT RECLAMATIONS NE CONTIENT PAS D'ELEMENT MOIS";
    public final static String MESSAGE_ERROR_ELEMENT_JSON_RECLAMATION_MISSING = "L'ELEMENT RECLAMATIONS NE CONTIENT PAS D'ELEMENT RECLAMATION";
    public final static String MESSAGE_ERROR_ELEMENT_JSON_SOIN_MISSING = "UN ELEMENT RECLAMATION NE CONTIENT PAS D'ELEMENT SOIN";
